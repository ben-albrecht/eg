...
_cffi_f_copy(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_ParseTuple(args, "OOO:copy", &arg0, &arg1, &arg2))
    return NULL;
...
static PyMethodDef _cffi_methods[] = {
  {"copy", _cffi_f_copy, METH_VARARGS, NULL},
...
PyMODINIT_FUNC
PyInit__cffi__xb6aa4e83x2ddbc00c(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__xb6aa4e83x2ddbc00c(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__xb6aa4e83x2ddbc00c", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
