...
PyMODINIT_FUNC
PyInit__cffi__xdfd345e6x2ddbc00c(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__xdfd345e6x2ddbc00c(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__xdfd345e6x2ddbc00c", _cffi_methods);
  if (lib == NULL)
    return;
  if (0 < 0 || _cffi_init() < 0)
    return;
