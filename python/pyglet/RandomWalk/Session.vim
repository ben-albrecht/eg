...
silent only
cd ~/repos/eg/python/pyglet/RandomWalk
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 game/cell.py
badd +0 game/physicalobject.py
badd +0 game/rectangle.py
badd +0 game/resources.py
badd +1 RandomWalk.py
argglobal
silent! argdel *
argadd game/cell.py
edit game/cell.py
