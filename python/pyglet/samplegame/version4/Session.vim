...
nnoremap  :call TagInsensitiveJump()
nnoremap <silent> ! :call RelOps_operate()!
nnoremap <silent> < :call RelOps_operate()<
nnoremap <silent> = :call RelOps_operate()=
nnoremap <silent> > :call RelOps_operate()>
...
nnoremap <silent> c :call RelOps_operate()c
nnoremap <silent> d :call RelOps_operate()d
nmap gx <Plug>NetrwBrowseX
nnoremap <silent> g? :call RelOps_operate()g?
nnoremap <silent> gq :call RelOps_operate()gq
nnoremap <silent> gU :call RelOps_operate()gU
nnoremap <silent> gu :call RelOps_operate()gu
nnoremap <silent> g~ :call RelOps_operate()g~
nmap s <Plug>(easymotion-s)
nnoremap <silent> y :call RelOps_operate()y
nnoremap <silent> zf :call RelOps_operate()zf
...
nnoremap <Plug>RelopsEnablernu :call RelOps_operate()
...
nnoremap <silent> <F3> :TagbarToggle
...
silent only
cd ~/repos/eg/python/pyglet/samplegame/version4
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 asteroids.py
badd +1 game/asteroid.py
badd +10 game/bullet.py
badd +17 game/load.py
badd +1 game/physicalobject.py
badd +1 game/player.py
badd +11 game/resources.py
badd +12 game/util.py
args asteroids.py
edit asteroids.py
...
setlocal tabstop=4
setlocal tags=~/repos/eg/.git/python.tags,~/repos/eg/.git/tags,./tags,tags;
...
silent! normal! zE
let s:l = 90 - ((89 * winheight(0) + 48) / 96)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
90
normal! 0
tabedit game/player.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
2
normal! 029|
tabedit game/physicalobject.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
